/* ============================================================
   EduNex LMS — sample data (window.VZ)
   English + career coaching for Vietnamese people in New Zealand.
   Multiple coaches (incl. Ms. Jane). Same shape as the shared
   screens expect, so every view re-skins automatically.
   ============================================================ */
(function () {
  const C = {
  ...
  // --- Coaches (multiple teachers — not just Ms. Jane) ---
  const teachers = [
  ...
  // schedule day index: 0=Mon … 6=Sun ; todayIndex = 1 (Tuesday, 14 June 2026)
  const classes = [
    { id:'c1', name:'VIP Career Program', subject:'Career · Job Guaranteed', teacher:'t1', color:C.gold,  status:'active', room:'Online 1:1', level:'All levels', students:8, price:4000,
      schedule:[{d:1,s:'18:30',e:'20:00'},{d:3,s:'18:30',e:'20:00'}], zalo:'zalo.me/g/edunex-vip', materials:18 },
    { id:'c2', name:'CV & Interview Mastery', subject:'Career · 1:1 Coaching', teacher:'t1', color:C.amber, status:'active', room:'Online 1:1', level:'Intermediate', students:14, price:399,
      schedule:[{d:1,s:'17:00',e:'18:30'},{d:4,s:'17:00',e:'18:30'}], zalo:'zalo.me/g/edunex-platinum', materials:12 },
    { id:'c3', name:'CV & Interview Jumpstart', subject:'Career · 1:1 Coaching', teacher:'t5', color:C.moss, status:'active', room:'Zoom 1', level:'Beginner', students:22, price:199,
      schedule:[{d:2,s:'18:00',e:'19:30'}], zalo:'zalo.me/g/edunex-gold', materials:8 },
    { id:'c4', name:'Job-Hunting Roadmap', subject:'Career · Self-paced', teacher:'t5', color:C.slate, status:'active', room:'On-demand', level:'All levels', students:64, price:49,
      schedule:[{d:5,s:'10:00',e:'11:00'}], zalo:'zalo.me/g/edunex-silver', materials:24 },
    { id:'c5', name:'Workplace English', subject:'English', teacher:'t3', color:C.indigo, status:'active', room:'Zoom 2', level:'Intermediate', students:18, price:89,
      schedule:[{d:1,s:'19:00',e:'20:30'},{d:4,s:'19:00',e:'20:30'}], zalo:'zalo.me/g/edunex-workenglish', materials:16 },
    { id:'c6', name:'IELTS Booster', subject:'English · IELTS', teacher:'t2', color:C.teal, status:'active', room:'Zoom 1', level:'Upper-Int', students:12, price:129,
      schedule:[{d:0,s:'17:30',e:'19:00'},{d:2,s:'17:30',e:'19:00'}], zalo:'zalo.me/g/edunex-ielts', materials:14 },
    { id:'c7', name:'Conversation Club', subject:'English', teacher:'t4', color:C.plum, status:'active', room:'Hub', level:'Elementary', students:16, price:39,
      schedule:[{d:3,s:'18:00',e:'19:30'}], zalo:'zalo.me/g/edunex-convo', materials:6 },
    { id:'c8', name:'Pronunciation Lab', subject:'English', teacher:'t4', color:C.rust, status:'soon', room:'Studio', level:'All levels', students:9, price:59,
      schedule:[{d:5,s:'13:00',e:'14:30'}], zalo:'zalo.me/g/edunex-pronlaB', materials:4 },
    { id:'c9', name:'Interview English', subject:'English · Career', teacher:'t3', color:C.navy, status:'soon', room:'Zoom 2', level:'Intermediate', students:7, price:79,
      schedule:[{d:5,s:'14:00',e:'15:30'}], zalo:'zalo.me/g/edunex-interview', materials:3 },
    { id:'c10', name:'LinkedIn & Branding', subject:'Career', teacher:'t5', color:C.amber, status:'paused', room:'Zoom 1', level:'All levels', students:11, price:69,
      schedule:[{d:4,s:'12:00',e:'13:00'}], zalo:'zalo.me/g/edunex-linkedin', materials:5 },
  ];

  // --- Learners (adults; "year" repurposed as learning focus) ---
  ...
  // Homework / assignments for the focus student (classes c2, c5, c6)
  const homework = [
  ...
  // Submissions waiting for a teacher (Ms. Jane: c1, c2)
  const submissions = [
  ...
  // Results / grades for the focus student
  const results = [
  ...
  // Payments / invoices for the focus student
  const payments = [
  ...
  window.VZ = {
    ...
    homework, submissions, results, payments,
